...
import com.studygo.settings.form.*;
import com.studygo.settings.validator.NicknameValidator;
import com.studygo.settings.validator.PasswordFormValidator;
...
public class SettingController {
    ...
    public String profileUpdateForm(@CurrentUser Account account, Model model) {
        ...
        model.addAttribute(modelMapper.map(account, com.studygo.settings.Profile.class));

        return SETTINGS_PROFILE_VIEW_NAME;
    }

    @PostMapping(SETTINGS_PROFILE_URL)
    public String updateProfile(@CurrentUser Account account, @Valid @ModelAttribute com.studygo.settings.Profile profile,
